...
- RTI Connext DDS 7.5.x (Modern C++ API) 버전 고정 사용
...
- `Idlkit/idl/` 하위의 `.idl` 파일이 **최상위 소스**이며, 반드시 버전 관리에 커밋
...
- `NDDSHOME` 환경변수 필수, CMake가 `RTI_LIB_DIR`(VS2017/2019/2022 버전)을 자동 감지 후 `nddscpp2`, `nddsc`, `nddscore`를 링크
