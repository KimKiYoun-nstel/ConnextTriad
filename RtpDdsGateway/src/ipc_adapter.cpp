        ...
        try {
            ...
            if (op == "create" && kind == "participant") {
                ...
                if (res.ok) {
                    ...
                    LOG_ERR("IPC", "writer creation failed: domain=%d pub=%s topic=%s type=%s category=%d reason=%s",
                ...
                if (res.ok) {
                    ...
                    LOG_ERR("IPC", "reader creation failed: domain=%d sub=%s topic=%s type=%s category=%d reason=%s",
